...
export default function RestaurantEmployeePermissionsDialog({
  open,
  onOpenChange,
  restaurantId,
  employee,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[85vh] max-w-2xl flex-col" data-testid="dialog-restaurant-employee-permissions">
        <DialogHeader>
                      ...
                      return (
                        ...
                        >
                          <Checkbox
                            ...
                            data-testid={`checkbox-restaurant-permission-${permission.key}`}
                          />
        ...
        <DialogFooter>
          ...
          <Button
            ...
            data-testid="button-save-restaurant-employee-permissions"
          >
