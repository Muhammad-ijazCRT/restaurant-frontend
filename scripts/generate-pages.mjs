...
const routes = [
  ["page.tsx", "@/views/shared/landing-page", "LandingPage"],
  ["super-admin/login/page.tsx", "@/views/admin/login", "SuperAdminLogin"],
  ["super-admin/dashboard/page.tsx", "@/views/admin/dashboard", "AdminDashboard", "admin"],
  ["super-admin/profile/page.tsx", "@/views/shared/profile-page", "ProfilePage", "admin"],
  ["super-admin/settings/page.tsx", "@/views/shared/settings-page", "SettingsPage", "admin"],
  ["admin/vendors/page.tsx", "@/views/admin/vendors", "AdminVendors", "admin"],
  ["admin/vendors/onboard/page.tsx", "@/views/admin/vendor-onboard", "VendorOnboard", "admin"],
  ["admin/vendors/[id]/page.tsx", "@/views/admin/vendor-detail", "VendorDetail", "admin"],
  ["admin/vendors/[id]/onboard/page.tsx", "@/views/admin/vendor-onboard", "VendorOnboard", "admin"],
  ["admin/restaurants/page.tsx", "@/views/admin/restaurants", "AdminRestaurants", "admin"],
  ["admin/restaurants/onboard/page.tsx", "@/views/admin/restaurant-onboard", "RestaurantOnboard", "admin"],
  ["admin/restaurants/[id]/page.tsx", "@/views/admin/restaurant-detail", "RestaurantDetail", "admin"],
  ["admin/restaurants/[id]/onboard/page.tsx", "@/views/admin/restaurant-onboard", "RestaurantOnboard", "admin"],
  ["admin/restaurants/[id]/catalog/[vendorId]/page.tsx", "@/views/admin/restaurant-catalog", "RestaurantCatalog", "admin"],
  ["admin/relationships/page.tsx", "@/views/admin/relationships", "AdminRelationships", "admin"],
  ["admin/relationships/[id]/page.tsx", "@/views/admin/relationship-detail", "RelationshipDetail", "admin"],
  ...
  ["restaurant/profile/page.tsx", "@/views/shared/profile-page", "ProfilePage", "restaurant"],
  ["restaurant/settings/page.tsx", "@/views/shared/settings-page", "SettingsPage", "restaurant"],
  ...
  ["vendor/profile/page.tsx", "@/views/shared/profile-page", "ProfilePage", "vendor"],
  ...
  ["shipping-company/profile/page.tsx", "@/views/shared/profile-page", "ProfilePage", "shipping"],
  ["shipping-company/settings/page.tsx", "@/views/shared/settings-page", "SettingsPage", "shipping-settings"],
];
